    ...
    class RenderChart
      ...
      INPUT_SCHEMA = {
        ...
        properties: {
          ...
          chart_type: { type: 'string', enum: %w[bar scatter line timeline] },
          x_field: { type: 'string', description: 'Required for bar/scatter/line' },
          y_field: { type: 'string', description: 'Required for bar/scatter/line' },
